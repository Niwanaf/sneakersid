...
(function ($) {
    ...
    SNEAKER.initScrollSpy = function() {
    ...
    SNEAKER.onClickScroll = function() {
    ...
    SNEAKER.defaultAddressCheckbox = function() {
    ...
    SNEAKER.reshopNavigation = function() {
        $('#navigation').shopNav();
        $('#navigation1').shopNav();
        $('#navigation2').shopNav();
        $('#navigation3').shopNav();
    ...
    SNEAKER.onTabActiveRefreshSlider = function() {
    ...
    SNEAKER.primarySlider = function() {
    ...
    // Bind all sliders into the page
    SNEAKER.productSlider = function() {
    ...
    // Testimonial Slider
    SNEAKER.testimonialSlider = function() {
    ...
    SNEAKER.appConfiguration = function() {
        $('body').removeAttr('class');
        $('.preloader').removeClass('is-active');
    };

    // Bind isotope filter plugin
    SNEAKER.isotopeFilter = function() {
    ...
    SNEAKER.timerCountDown = function() {
    ...
    // Input Counter
    SNEAKER.initInputCounter = function() {
    ...
    // Product Detail Init
    SNEAKER.productDetailInit = function() {
    ...
    SNEAKER.modalProductDetailInit = function() {
    ...
    SNEAKER.shopCategoryToggle = function() {
    ...
    SNEAKER.shopPerspectiveChange = function() {
    ...
    SNEAKER.shopSideFilter = function() {
    ...
    SNEAKER.showNewsletterModal = function() {
    ...
    $(window).on('load',function () {
        ...
        SNEAKER.initScrollUp();
        SNEAKER.initTooltip();
        SNEAKER.initModal();
        SNEAKER.defaultAddressCheckbox();
        SNEAKER.initScrollSpy();
        SNEAKER.onClickScroll();
        SNEAKER.reshopNavigation();
        SNEAKER.primarySlider();
        SNEAKER.productSlider();
        SNEAKER.tabSlider();
        SNEAKER.onTabActiveRefreshSlider();
        SNEAKER.brandSlider();
        SNEAKER.testimonialSlider();
        SNEAKER.appConfiguration();
        SNEAKER.isotopeFilter();
        SNEAKER.timerCountDown();
        SNEAKER.initInputCounter();
        SNEAKER.productDetailInit();
        SNEAKER.modalProductDetailInit();
        SNEAKER.shopCategoryToggle();
        SNEAKER.shopPerspectiveChange();
        SNEAKER.shopSideFilter();
})(jQuery);